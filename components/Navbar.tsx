          ...
          <div className="flex h-[62px] items-center justify-between lg:h-[66px]">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a
                ...
                className={`text-[13px] font-semibold transition-all duration-200 ${scrolled ? "text-slate-400 hover:text-slate-700" : "text-white/38 hover:text-white/70"}`}
                style={{ fontFamily: "var(--font-manrope)" }}
              >
                WhatsApp
              </a>
              <motion.button
                ...
                className={`cursor-pointer btn-hero-primary px-5 py-2.5 text-sm font-bold min-h-0 ${
                  scrolled
                    ? "!bg-none !shadow-[0_4px_16px_rgba(0,51,204,0.28)]"
                    : ""
                }`}
                style={{
          ...
          >
            <div className="flex flex-col px-3 py-3 gap-0.5">
              ...
              <div className="mt-2 flex flex-col gap-2 px-1 pb-1">
                <a href="https://wa.me/13464593090" target="_blank" rel="noopener noreferrer" className="w-full rounded-xl border border-slate-100 py-3 text-center text-sm font-semibold text-slate-500 hover:bg-slate-50 transition-colors" style={{ fontFamily: "var(--font-manrope)" }}>
                  WhatsApp · (346) 459-3090
                </a>
                <button
                  onClick={() => { setMobileOpen(false); scrollTo("#contacto"); }}
                  className="cursor-pointer w-full rounded-xl bg-[#0033CC] py-3 text-sm font-bold text-white transition-colors hover:bg-[#001899]"
                  style={{ fontFamily: "var(--font-manrope)" }}
                >
                  Consulta Gratis
                </button>
